...
%                 diff = [diff,max(aa(:,1))-min(aa(:,1))];
    ...
    pupil_data3=pupil_data3(pupil_data3(:,1701)~=0,:);
    pupil_data4=pupil_data4(pupil_data4(:,1701)~=0,:);
    pupil_data5=pupil_data5(pupil_data5(:,1701)~=0,:);
    baseline1  = mean(pupil_data1(:,600:800),2);
    baseline2  = mean(pupil_data2(:,600:800),2);
    baseline3  = mean(pupil_data3(:,600:800),2);
    baseline4  = mean(pupil_data4(:,600:800),2);
    baseline5  = mean(pupil_data5(:,600:800),2);
    ...
    %         figpath='C:\Users\86186\Desktop\fig';
    name = [figpath,'/',subject{kk},'_tilt_new2.png'];
    title(title_name)
    saveas(gca,name)
