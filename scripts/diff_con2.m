...
% set(gca,'XTick',xt); 
% set(gca,'XTicklabels',{'Cartesian cardinal','Cartesian Oblique'}); 
% % xticks(xt)
% % xticklabels({'Cartesian cardinal','Cartesian Oblique'})
% %legend(Y_total(:,1:5),{'0.5','1','2','4','8'})
% ylabel('# of MS')
% title('All Subject')
% figpath='C:\Users\86186\Desktop\fig';
% name = [figpath,'/',subject{i},'_MScvo.png'];
% %saveas(gca,name) 
