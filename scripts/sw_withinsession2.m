function  [acc, rate_trial,rate_sti]  = sw_withinsession2(tab,MS_TEMP, window_size,samplingRateData,time,step_size)
num_win = ceil((421-window_size)/step_size);
start_time = 0 : step_size : step_size*num_win;
end_time = window_size : step_size : window_size + step_size*num_win;
if end_time(num_win+1) > 421
    end_time(num_win+1) = 421;
end
