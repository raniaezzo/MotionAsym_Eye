%% this script will get figures with different condition with different subjects
clc; clear all;
...
%     legend('8')
    ...
    saveas(gca, sprintf('%s/rate_bycondition.png',MATpath))
    ...
    set(c(1,2),'FaceColor','Y','BarWidth',0.9);
